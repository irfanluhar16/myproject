...
public class HomePageAdapter extends RecyclerView.Adapter {
    ...
    public class HorizontalProductViewHolder extends RecyclerView.ViewHolder {
        ...
        private RecyclerView horizonatlRecyclerView;
        ...
        public HorizontalProductViewHolder(@NonNull View itemView) {
            ...
            horizonatlRecyclerView = itemView.findViewById(R.id.horizontal_scroll_layout_recyclerview);
            horizonatlRecyclerView.setRecycledViewPool(recycledViewPool);
        }
        ...
        private void setHorizontalProductLayout(List<HorizontalProductScrollModel> horizontalProductScrollModelList, final String title, String color, final List<WishlistModel> viewAllProductList) {
            ...
            horizonatlRecyclerView.setLayoutManager(linearLayoutManager);

            horizonatlRecyclerView.setAdapter(horizontalProductScrollAdapter);
